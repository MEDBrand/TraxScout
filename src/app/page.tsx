      ...
      <section className="py-20 sm:py-24 px-6">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 gap-4 sm:gap-6">
            {/* Basic */}
            <div className="bg-[#0A0A0A] border border-white/10 rounded-3xl p-8 h-full flex flex-col hover:-translate-y-1 transition-transform duration-300">
              <div className="mb-6">
            ...
            {/* Pro */}
            <div className="bg-[#0A0A0A] border-2 border-[#7C3AED]/50 rounded-3xl p-8 relative h-full flex flex-col hover:-translate-y-1 transition-transform duration-300">
